    ...
    \subsection{Experimental Results}
        ...
        \begin{figure}[H]
            ...
            \subfloat[Top-Down View (X-Y)] { % Figure A
                % Replace example-image-a with your actual path: ./fig/plots/circle_2d_top_down.png
                \includegraphics[width=0.48\textwidth, height=0.48\textwidth]{example-image-a}
            }
            % \hspace{0.02\textwidth} % Optional: adds a specific horizontal space between subfigures
            % \hfill % Optional: pushes subfigures to the edges of the available space
            \subfloat[Side View (X-Z)] { % Figure B
                \raisebox{0.12\textwidth}{% <--- Adjust this value to control the amount of lift
                    % Replace example-image-b with your actual path: ./fig/plots/circle_2d_side.png
        ...
        \begin{figure}[H]
            ...
            \subfloat[Side View (X-Z)] {
            \includegraphics[width=0.48\textwidth, height=0.48\textwidth]{./fig/plots/circle_3d_side.png}
            }
            \caption{
        ...
        \begin{figure}[H]
            ...
            \subfloat[Side View (X-Z)] {
            \includegraphics[width=0.48\textwidth, height=0.48\textwidth]{./fig/plots/circle_3d_z_clip_side.png}
            }
            \caption{
        ...
        \begin{figure}[H]
            ...
            \subfloat[Side View (X-Z)] {
            \includegraphics[width=0.48\textwidth, height=0.48\textwidth]{./fig/plots/circle_3d_z_rule_side.png}
            }
            \caption{
