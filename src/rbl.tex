...
\section{Introduction to the RBL}
    ...
    \subsection{Key principles}
        ...
        The position of the centroid \( \mathbf{c}_{V_i} \) of a region \( V_i \), weighted by the function \( \varphi_i(\mathbf{q}) \), is used to guide the control. It is defined as:

        \begin{equation}
            \mathbf{c}_{V_i} = \frac{\int_{V_i} \mathbf{q} \varphi_i(\mathbf{q}) \, d\mathbf{q}}{\int_{V_i} \varphi_i(\mathbf{q}) \, d\mathbf{q}},
        \end{equation}
