...
\section{Overview of RBL - TODO rename}
    ...
    \subsection{Key principles}
        ...
        This goal region is denoted as $G(\mathbf{g}_i, r_g)$, where $\mathbf{g}_i$ is center and $r_g$ is radius of goal region. %TODO rename goal to something like G(g_i, r_g)
        ...
        \end{equation}
        where $\beta_i$ is weighting variable for points $\mathbf{q}$ and $\mathbf{d}_i$ is current agent's destination.
