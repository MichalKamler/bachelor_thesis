\chapter{UAV Navigation Using the RBL Algorithm and LiDAR Sensing\label{chap:lidar}}
    ...
    \label{sec:experimental_results}
        ...
        \subsection{Performance in Simulated Environments}
            ...
            The 2D \ac{RBL}, however, sometimes failed by becoming stuck between these same obstacles.
            \begin{table}[H]
                \centering
                \renewcommand{\arraystretch}{1.2}
                ...
                \ac{RBL} 2D                         & 20.00           & 30.27 $\pm$ 0.12                  & 63.46 $\pm$ 0.74                  &  63.46 $\pm$ 0.74                               &  0.48 $\pm$ 0.01                         \\ \hline
                \ac{RBL} $\text{3D}_{\text{rule}}$  & 100.00          & 28.40 $\pm$ 10.68                 & 50.90 $\pm$ 33.51                 &  99.86 $\pm$ 16.01                              &  0.54 $\pm$ 0.27                         \\ \hline
                \end{tabular}
            \end{table}
