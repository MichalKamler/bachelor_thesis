\chapter{UAV Navigation Using the RBL Algorithm and LiDAR Sensing\label{chap:lidar}}
    ...
    \label{sec:lidar_perception}
        ...
        \subsection{Preprocessing Techniques}
            ...
            The point cloud is than fed into \ac{Point-LIO} state estimator and bonxai mapping. 
        ...
        \subsection{Voxel-Based Modification of Cell $\mathcal{A}$}
            ...
            Considering the point $\mathbf{p}_{\text{closest}}$ as an obstacle, the sensing cell $\mathcal{S}$ is partitioned to form cell $\mathcal{A}$.
        ...
        \subsection{Challanges in Integration}
            ...
            \begin{figure}[htbp]
                ...
                \caption{
                    ...
                    Subfigure (a) shows a modeled \ac{UAV} with visualized \ac{LiDAR} mounting parameters, including the \ac{LiDAR} elevation field of view $\alpha$ and tilt angle $\gamma$. 
                    Subfigure (b) displays the real \ac{UAV} used in the experiment with the \ac{LiDAR} mounted according to the same configuration.                                                
                }
                \label{fig:uavs}
            \end{figure}
            ...
            Therefore, a constraint is intorduced - the \ac{UAV} maintains its yaw rotation towards the current centroid $\mathbf{c}_{\mathbf{A}}$ and moves towards the centroid only when this centroid is positioned within a $\pm$45° angular range from the direction the \ac{LiDAR} is tilted towards (the \ac{UAV}'s x-axis).
            This 90° forward sector for movement is determined by the \ac{UAV}'s physical structure, specifically to prevent the \ac{UAV} from moving into areas where mounting rods for GPS obstruct active sensing.
            ...
            \begin{equation}
                \mathcal{S}_i' = \{ \mathbf{q} \in \mathcal{S}_i \mid \mathbf{n}1 \cdot (\mathbf{q} - \mathbf{p}_{L}) \geq 0 \land \mathbf{n}2 \cdot (\mathbf{q} - \mathbf{p}_{L}) \leq 0 \}\text{,}
            \end{equation}
    ...
    \label{sec:experimental_results}
        ...
        \subsection{Simulation Setup}
            ...
            \end{itemize}
            The \ac{UAV}'s starting position was set at one corner of the rectangular area (-22.0, -33.0, 2.0), and the goal position was set at the opposite corner (22.0, 33.0, 5.0), resulting in almost of 80 meters between them.
        ...
        \subsection{Real-World Experiments in a Forest Environment}
            ...
            \begin{itemize}
                ...
                \item \textbf{UAV Platform: } \\
                    A custom-built multirotor \ac{UAV} from the MRS group was used for this experiment X450. 
        ...
        \subsection{Performance in Real-World Experiment}
            For the real world experiment I have chosen 2 flights to describe and one fail flight. 
            ...
            \begin{figure}[H]
                \centering
                \subfloat[Conservative flight trajectory] {
                \includegraphics[width=0.48\textwidth]{./fig/rviz/flight_484.png}
                }
                \subfloat[Aggressive flight trajectory] {
        ...
        \subsection{Comparative Analysis}
            ...
            \subsection{Comparison with 2D Baseline}
                ...
                \end{itemize}
                A notable behavior observed in the 3D tests was the \ac{UAV}'s tendency to initially increase altitude after takeoff, effectively moving away from the ground obstacle, before potentially descending again as it were getting closer to the goal. 
