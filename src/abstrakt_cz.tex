...
Navržený algoritmus byl hodnocen pomocí rozsáhlých simulací s více agenty a validován experimenty v reálném lesním prostředí s jedním robotem.

Simulace potvrdily úspěšné 3D rozšíření algoritmu RBL a prokázaly efektivní koordinaci více robotů. 
Experimenty v reálném světě ověřily schopnost systému založeného na 3D RBL pro autonomní navigaci z bodu do bodu v lese. 
